...
$number = $_POST['number'];
    ...
    $sql = "UPDATE `participant` SET `nom`='$nom',`prenom`='$prenom',`email`='$email',`number`='$number' WHERE id=$id";
...
<div class="text-center mb-4">
    <h3>Modifier le Tableau d'inscris</h3>
    <p class="text-muted">Appuyez sur actualiser après toute modification</p>
...
$sql = " SELECT `id`, `nom`, `prenom`, `email`, `number` FROM `participant` WHERE id = $id LIMIT 1";
$result = mysqli_query($conn, $sql);
...
<div class="container d-flex justity-content-center">
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            ...
            <input type="number" class="form-control" value="<?php echo $row['number']?>" name="number" required>
</div>
</br>
<div>
</br>
<button type ="submit" class="btn btn-success" name="submit" >Actualiser</button>
